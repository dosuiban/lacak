...
class Menu:
    ...
    def CreateTemplate(Template,Content,filename,htmlcontent,username):
        ...
        <body>
         <p>PDF REPORT FOR {} GRAPH</p>
          <div class = "Metadata">
            ...
            <p>PDF GENERATED BY DOSUIBAN</p>
            <p>GENERATED ON: {}</p>
            <p>DOSUIBAN DOWNLOAD LINK: https//github.com/Lucksi/DOSUIBAN</p>
           </div>
            <br>
            {}
        </body>
        ...
        choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(langfile, "Transfer", "Question", "None") + Font.Color.GREEN + "[#DOSUIBAN#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
